 ...
 * supajax
 *
 * Converts Elgg tabbed areas into ajax live reloads
 */
	...
	if ($default == FALSE) {
		...
		if (elgg_is_xhr()) {
		   // echo ("<script>alert('supajax_route_hook');</script>");
			...
			// Page is drawn and standard filter is 1st called
...
function tabs_filter_hook($hook, $type, $return, $params) {
	...
	if ($page == "all" ||
		$page == '' ||
		substr($page, 0, 8) == 'featured' ||
		substr($page, 0, 4) == 'user' ||
		substr($page, 0, 5) == 'owner' ||
		substr($page, 0, 7) == 'friends' ||
		substr($page, 0, 7) == 'popular' ||
		substr($page, 0, 6) == 'online' ||
		substr($page, 0, 6) == 'newest' ||
		substr($page, 0, 13) == 'siteimagesall' ||
		substr($page, 0, 15) == 'siteimagesowner' ||
		substr($page, 0, 17) == 'siteimagesfriends' ||
		substr($page, 0, 14) == 'recentlyviewed' ||
		substr($page, 0, 17) == 'recentlycommented' ||
		substr($page, 0, 10) == 'mostviewed' ||
		substr($page, 0, 15) == 'mostviewedtoday' ||
		substr($page, 0, 19) == 'mostviewedthismonth' ||
		substr($page, 0, 19) == 'mostviewedlastmonth' ||
		substr($page, 0, 18) == 'mostviewedthisyear' ||
		substr($page, 0, 13) == 'mostcommented' ||
		substr($page, 0, 18) == 'mostcommentedtoday' ||
		substr($page, 0, 22) == 'mostcommentedthismonth' ||
		substr($page, 0, 22) == 'mostcommentedlastmonth' ||
		substr($page, 0, 21) == 'mostcommentedthisyear' ||
		substr($page, 0, 6) == 'tagged') {
